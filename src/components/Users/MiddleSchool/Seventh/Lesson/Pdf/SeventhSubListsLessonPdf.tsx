...
const SeventhSubListsLessonPdf: React.FC = () => {
  const sections = [
    {
      id: "sevenmalagasylessonpdf",
      subject: "MLG",
      href: "/",
    },
    {
      id: "sevenenglishlessonpdf",
      subject: "ENG",
      href: "/",
    },
    {
      id: "sevenfrenchlessonpdf",
      subject: "FRE",
      href: "/",
    },
    {
      id: "sevenmathslessonpdf",
      subject: "MATH",
      href: "/",
    },
    {
      id: "sevenhistorylessonpdf",
      subject: "HIST",
      href: "/",
    },
    {
      id: "sevengeographylessonpdf",
      subject: "GEO",
      href: "/",
    },
    {
      id: "sevenphysicslessonpdf",
      subject: "PHY",
      href: "/",
    },
    {
      id: "sevenchemistrylessonpdf",
      subject: "CHIM",
      href: "/",
    },
    {
      id: "sevensvtlessonpdf",
      subject: "SVT",
      href: "/",
    },
    {
      id: "seventechnologylessonpdf",
      subject: "TECH",
      href: "/",
    },
    {
      id: "sevensportlessonpdf",
      subject: "SPORT",
      href: "/",
    },
  ];
  ...
  return (
    ...
    <div className="lg:grid md:grid transform flex flex-col grid-cols-2 md:px-10 lg:grid lg:grid-cols-5 lg:ml-0 justify-center w-full h-full p-10">
      ...
      <div className="p-10 flex items-center justify-center">
        <h1 className="text-lg">Your are in the Grade 7 lesson Pdf section</h1>
      </div>
    </>
  );
};
...
export default SeventhSubListsLessonPdf;
