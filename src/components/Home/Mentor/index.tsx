    ...
    return (
        <section className="bg-rose-300" id="mentor" >
            <div className='container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4 relative'>
                <h2 className="text-midnight_text text-5xl font-semibold">Learn with our <br /> mentors.</h2>
                            ...
                            <div className='m-3 py-14 md:my-10 text-center'>
                                <div className="relative">
                                    ...
                                    <div className="absolute right-[84px] bottom-[102px] bg-white rounded-full p-3">
                                        <Image src={'/images/mentor/pdplogo.png'} alt="linkedin-image" width={55} height={60} />
                                    </div>
                                </div>
                                <div className="-mt-10">
