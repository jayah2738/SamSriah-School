...
const Contact = () => (
    <section className=" sm:p-20 z-[-50]" style={{backgroundImage: "url('/images/newsletter/contactbg.png')", backgroundSize: "cover", backgroundRepeat: "no-repeat"}}>
        <div className="lg:px-8 mx-auto" >
            ...
            <form action="#" method="POST" className="mx-auto bg-white sm:m-0  rounded-[35px]  p-6 max-w-xl sm:mt-10">
                            ...
                            <div className="flex border-2 rounded-full bg-white outline-1 -outline-offset-1 outline-gray-300 has-[input:focus-within]:outline-2 has-[input:focus-within]:-outline-offset-2 has-[input:focus-within]:outline-amber-500">
                                <div className="grid shrink-0 grid-cols-1 focus-within:relative">
                                    <select
                                        ...
                                        aria-label="Country"
                                        className="col-start-1  row-start-1 w-full appearance-none border border-amber-500 border-2 rounded-full py-2 pr-7 pl-3.5 text-base text-gray-500 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-amber-500 sm:text-sm/6"
                                    >
                                        <option>US</option>
                                        <option>CA</option>
                                        <option>EU</option>
                                ...
                                <input
                                    ...
                                    name="phone-number"
                                    id="phone-number"
                                    className="block min-w-0 grow py-1.5 pr-3 pl-1 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6 rounded-full"
