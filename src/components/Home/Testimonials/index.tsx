...
const Testimonial = () => {
    ...
    return (
        <section id="testimonial">
            ...
            <h2 className="text-midnight_text text-5xl font-semibold">What our Students <br /> say.</h2>
                <Slider {...settings}>
                    {TestimonialData.map((items, i) => (
                        <div key={i}>
                            <div className={`bg-white rounded-2xl border-b-4 border-l-4 border-rose-500 m-4 p-5 my-20 relative ${i % 2 ? 'shadow-testimonial-shadow2' : 'shadow-testimonial-shadow1'}`}>
