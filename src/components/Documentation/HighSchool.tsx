      ...
      <div className="pb-10 md:scroll-m-[180px] scroll-m-28" id="configuration">
        ...
        <span className="text-amber-500 font-bold">
          ...
          <span className="text-gray-500 font-normal">
            ...
            and personally. With a strong college-preparatory program, advanced
            courses, and personalized guidance, students are prepared for
            universities and future careers. We emphasize responsibility,
            innovation, and character—ensuring each graduate is ready to lead
            and succeed in the world ahead.
          </span>
        </span>
      </div>
    </>
