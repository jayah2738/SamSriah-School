      ...
      {DocsNav.map((item) => {
        return (
          <Link
            ...
            className={`py-2.5 hover:bg-amber-500 hover:text-white dark:hover:text-primary xl:min-w-60 lg:min-w-52 min-w-full px-4 rounded-lg text-base font-medium  ${item.hash === navItem
