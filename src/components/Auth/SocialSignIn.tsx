    ...
    <>
      <div className="flex gap-4">
        <button
          ...
          className="flex w-full items-center justify-center gap-2.5 rounded-full p-3.5 hover:bg-amber-100 shadow-md shadow-rose-500 transition duration-900 ease-in-out bg-amber-500 hover:text-black text-white border border-amber-500"
        >
          Sign In
          <svg
            width="23"
